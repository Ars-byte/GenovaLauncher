...
- **FIX:** Ahora el resolvedor de las claves internas tendra en cuenta `sunshinelauncher-config.json` a la hora de actualizar los datos.
...
# [v2.0] - 2026-01-02
- **Nombre nuevo:** Ahora pasara de MCPETool a la naturaleza de un launcher llamado **SunshineLauncher**.

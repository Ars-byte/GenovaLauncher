...
UI_SETUP_WELCOME_TITLE = "Bienvenidos a GenovaLauncher v{VERSION_LAUNCHER}"
...
UI_SETUP_FINISH_SUB = """¡Muchas gracias por elegir GenovaLauncher v{VERSION_LAUNCHER}!
...
UI_TRAY_SHOW = "Mostrar GenovaLauncher"
UI_TRAY_QUIT = "Salir"
...
# ── Update checker ──
UI_UPDATE_AVAILABLE = "Versión {version} disponible. Actualiza GenovaLauncher para obtener las novedades."
